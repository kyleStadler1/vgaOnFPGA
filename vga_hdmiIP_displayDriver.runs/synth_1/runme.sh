...
HD_PWD='C:/Users/Kyle/blackboard/vga_hdmiIP_displayDriver/vga_hdmiIP_displayDriver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pmodVGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pmodVGA.tcl
