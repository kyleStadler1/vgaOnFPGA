...
HD_PWD='C:/Users/Kyle/blackboard/vga_hdmiIP_displayDriver/vga_hdmiIP_displayDriver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pmodVGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_pmodVGA.tcl -notrace
